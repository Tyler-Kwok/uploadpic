...
if($this.input.prop("files").length < 1) {
...
if($this.settings.multi === false && $this.input.prop("files").length > 1) {
...
$this.multiSend($this.input.prop("files"));
}
else {
$this.singleSend($this.input.prop("files")[0]);
}
};
